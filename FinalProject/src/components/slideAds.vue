...
<template>
    <div>
        <swiper :modules="[ Pagination, Autoplay, Controller, Navigation]"
         effect="cube"
         :grab-cursor="true"
         :loop="true"
         :pagination="true"
        ...
        <div class="overtext">
            <div class="ontext"> 
                ...
                <p>The product that been recently trentding would not be dissopointed.</p>
                <div class="bun">shop now</div>
            </div>
        </div>
    </div>
</template>
